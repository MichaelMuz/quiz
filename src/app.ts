...
function layout(body: string): string {
  ...
  .header-side{display:flex;align-items:center;gap:12px}.nav{color:#a5eff9;text-decoration:none;font-size:.88rem;font-weight:800}.platform{color:var(--muted);font-size:.82rem;margin:-16px 0 20px}.answer{white-space:pre-wrap}.references{display:flex;gap:14px;flex-wrap:wrap}.command-choice{white-space:pre-wrap}.progress-card h1{margin-bottom:8px}.progress-intro{color:var(--muted);margin:0 0 24px}.command-group+ .command-group{margin-top:28px}.command-group h2{font:900 1.35rem ui-monospace,monospace;color:var(--cyan);margin:0 0 12px}.concept{background:#181529;border:1px solid #37304f;border-radius:14px;padding:14px;margin-top:10px}.concept h3{font:800 1rem ui-monospace,monospace;margin:0 0 4px}.concept-platform{color:var(--muted);font-size:.76rem;margin-bottom:10px}.mode-row{display:grid;grid-template-columns:repeat(3,1fr);gap:7px}.mode{background:#27223c;border-radius:9px;padding:8px 6px;text-align:center}.mode-label{display:block;color:var(--muted);font-size:.68rem;text-transform:uppercase;letter-spacing:.06em}.status{display:block;font-size:.78rem;font-weight:850;margin-top:2px}.status.learning{color:#fde68a}.status.established{color:var(--good)}.status.unseen{color:#c4bfd8}@media(max-width:390px){.counter{display:none}.mode-label{font-size:.62rem}}
